...
public class TokenProviderTest {
    ...
    void generateToken() {
        ...
        String token = tokenProvider.generateToken(user, Duration.ofDays(4));
    ...
    void validToken_invalidToken() {
        ...
        String token = JwtFactory.builder()
                .expires(new Date(new Date().getTime() - Duration.ofDays(7).toMillis()))
                .build()
    ...
    @DisplayName("getUserId() : 토큰으로 user의 id를 가져올 수 있다. ")
    @Test
    void getUserId() {
